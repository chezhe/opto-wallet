const en = {
  ...
  'Chain not match': 'Chain not match',
  'Network not found': 'Network not found',
  'Transaction has been signed': 'Transaction has been signed',
  Transfering: 'Transfering',
  "Can't switch wallet when WalletConnect in use":
    "Can't switch wallet when WalletConnect in use",
  'Do not show again': 'Do not show again',
  'You can switch wallet here': 'You can switch wallet here',
  'You can switch network here': 'You can switch network here',
  'You can check notifications here': 'You can check notifications here',
  'This is your wallet address, copy it by simply tapping':
    'This is your wallet address, copy it by simply tapping',
  'Transfer tokens to other wallets': 'Transfer tokens to other wallets',
  'Receive tokens from other wallets': 'Receive tokens from other wallets',
  ...
  'You can search or access dApp with URL, and browse your favorite dApps':
    'You can search or access dApp with URL, and browse your favorite dApps',
  'Start exploring awesome dApps': 'Start exploring awesome dApps',
  'Your account is not activated, please fund it first':
    'Your account is not activated, please fund it first',
  'People are searching': 'People are searching',
  Connecting: 'Connecting',
  'Create NEAR account for me': 'Create NEAR account for me',
